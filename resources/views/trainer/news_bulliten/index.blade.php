    ...
    <div class="nk-block-head nk-block-head-lg">
        <div class="nk-block-between-md g-4">
            <div class="nk-block-head-content">
                <h2 class="nk-block-title fw-normal">News Bulliten</h2>
                <div class="nk-block-des">
                    <p>All the news related to Speedo Swim Squad will be published and
                        can be seen in here.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-inner">
                <div class="nk-help">
                    ...
                    <div class="nk-help-text">
                        <h5>Summer Camp</h5>
                        <p class="text-soft">Join us and develop your swimming skills at
                            our Spring Camp.
                            Our camp will run from 28th March - 1st April and 4th April
                            - 8th April in both the morning and afternoon at venues
                            across Dubai. Contact us now for more information and to
                            book you place.</p>
                    </div>
                    <div class="nk-help-action">
                        <a href="html/subscription/contact.html"
                            class="btn btn-lg btn-outline-primary">More Info</a>
                    </div>
                </div>
            </div>
        </div>
