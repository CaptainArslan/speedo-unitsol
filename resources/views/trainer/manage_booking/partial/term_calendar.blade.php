        ...
        var calendarEvents = [
            @foreach ($term_base_bookings as $term_base_booking)
                
                {
                    ...
                    id: '{{ $term_base_booking->id }}',
                    title: '{{ $term_base_booking->name }}',
                    start: '{{ $term_base_booking->start_date }}',
                    end: '{{ $term_base_booking->end_date }}',
                    allDaySlot: false,
                    backgroundColor: '{{ $term_base_booking->class->color }}',
                    color: '{{ $term_base_booking->class->color }}',
                    className: "{{ $term_base_booking->class->color }}",
                    description: "Class: {{ $term_base_booking->class->name  }} Days: "
