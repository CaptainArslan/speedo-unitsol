        ...
        <div class="nk-block-head nk-block-head-md">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Assessment</h3>
        ...
        <div class="nk-block nk-block-lg">
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    ...
                    <p>Select your session for student assessment.</p>
                </div>
            </div>
            <div class="row g-gs">
                ...
                @foreach ($classes as $class)
                    @if (count($class->termStudents) != 0)
                        ...
                        $lession_takes = App\Models\ClassSession::where('class_id', $class->id)
                            ->where('type', 'term')
                            ->count();
                        $attendance = App\Models\ClassSession::where('class_id', $class->id)
                            ->where('type', 'term')
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="us-data-list">
                                                        ...
                                                        <span class="us-aed"> {{ $class->no_of_class - $lession_takes }} /
                ...
                @foreach ($classes as $class)
                    @foreach ($class->termBaseBookingPackages as $package)
                        @if (count($package->packageStudents) != 0)
                            ...
                            // $last = substr($class->last_name, 0, 1);
                            $lession_takes = App\Models\ClassSession::where('class_id', $package->id)
                                ->where('type', 'package')
                                ->count();
                            $attendance_package = App\Models\ClassSession::where('class_id', $package->id)
                                ->where('type', 'package')
                                ->where('date', $current_date->format('Y-m-d'))
                                ->first();
                            ?>
                            @if (!is_null($attendance_package))
                                <div class="col-sm-6 col-xl-4">
                                    <div class="card card-bordered">
                                        <div class="us-card">
                                            ...
                                            <div class="us-card-data">
                                                ...
                                                <div class="us-data-list">
                                                    <span><strong>Date : </strong>
                                                        {{ $current_date->format('d M y') }}</span>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="us-data-list">
                                                            <span><strong>Lessons:</strong> </span>
                                                            <span class="us-aed">
                                                                {{ $package->no_of_class - $lession_takes }}
                                                                /
