                                ...
                                <ul class="preview-list">
                                        ...
                                        <ul class="d-flex g-3">
                                            <li>
                                                <div class="dropdown" style="width: 300px;">
                                                    <select name="venue_id" id="venue_select2" onchange="filterTerm(event,'post','{{ url('parent/filter-terms') }}','filter-form')" class="select2 form-control">
                                    ...
                                    <li class="preview-item">
                                        ...
                                        <ul class="d-flex g-3">
                                            ...
                                            ?>
                                            <li>
                                                <input type="checkbox" onchange="filterTerm(event,'post','{{ url('parent/filter-terms') }}','filter-form')" class="" name="student_id[]" value="{{ $student->id }}" placeholder="Search Product by Name">
                                ...
                                <ul class="preview-list">
                                    ...
                                    <li class="preview-item">
                                        ...
                                        <ul class="d-flex g-3">
                                            <li>
                                                <div class="dropdown" style="width: 300px;">
                                                    <select name="term_id" id="term_select2" onchange="filterTerm(event,'post','{{ url('parent/filter-terms') }}','filter-form')" class="select2 form-control">
                                    ...
                                    <li class="preview-item">
                                        ...
                                        <span class="preview-title overline-title"><em class="icon ni ni-map-pin"></em>Filter Class
                                            Level</span>
                                        <ul class="d-flex g-3">
                                            <li>
                                                <div class="dropdown" style="width: 300px;">
                                                    <select name="swimming_class_id[]" id="class_select2" multiple onchange="filterTerm(event,'post','{{ url('parent/filter-terms') }}','filter-form')" class=" form-control">
                                                        <option value="">- Select Class -</option>
                                                        @if (isset($classes))
                                                        @foreach ($classes as $class)
                                                        <option value="{{ $class->id }}" class="{{ $class->name }}">{{ $class->name }}
                                                        </option>
                                                        @endforeach
                                                        @endif
                                                    </select>
                                    ...
                                    <li class="preview-item">
                                        ...
                                        <ul class="d-flex g-3">
                                            <li>
                                                <div class="dropdown" style="width: 300px;">
                                                    <select name="class_type_id[]" id="venue" multiple onchange="filterTerm(event,'post','{{ url('parent/filter-terms') }}','filter-form')" class="class_type_select2 form-control">
                                    ...
                                    <li class="preview-item">
                                        ...
                                        <span class="preview-title overline-title"><em class="icon ni ni-map-pin"></em>Filter Days</span>
                                        <ul class="d-flex g-3">
                                            <li>
                                                <div class="dropdown" style="width: 300px;">
                                                    <select name="day_id[]" id="day" multiple onchange="filterTerm(event,'post','{{ url('parent/filter-terms') }}','filter-form')" class="day_select2 form-control">
                                                        <option value="">- Select Class Type -</option>
                                                        @foreach ($days as $day)
                                                    ...
                                                    <button type="button" onclick="removeAllBage()" class="btn ml-4 text-white" style="background-color: #3097FF !important"><span>Clear Filter</span></button>
                                                </div>
                                            </li><!-- li -->
                                        </ul>
                                    </li>
                                        ...
                                        <div class="owl-item">
                                            <div class="bbb_viewed_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                <div class="bbb_viewed_image">
                                                    <img style="width: 150px;height:150px;" src="{{ $image_url . '/' . $product->getFirstImage() }}" alt="">
                                                </div>
                                                <div class="bbb_viewed_content text-center">
                                                    ...
                                                    <div class="bbb_viewed_name">
                                                        <a href="javascript:void(0)" onclick="addToCart(event,'{{ url('parent/add-to-cart-product/' . $product->id) }}')" class="mt-2 btn btn-sm btn-dim btn-primary"><span>Add
                                                                to Cart</span></a>
                                                    </div>
                                                </div>
                                                <ul class="item_marks">
