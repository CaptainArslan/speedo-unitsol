<td class="us-class-schedule">
    ...
    if (isset($days_id)) {
        ...
        $day = $parent_term->termBaseBookingDays->where('day_id', 4)->first();
    }
    ?>
    @if (!is_null($day))
        @forelse ($child_terms as $term)
            ...
            ?>
            @if ($term->timing)
                <div class="us-class-list" id="us-scroll" onclick="scrollToDiv()" style="border: 2px solid {{ $term?->class->color }}!important;"
            ...
            @endif
            <div class="modal modal_close" id="displayClassDetail{{ $term->id }}">
                            ...
                            <div class="nk-modal">
                                <div class="row">
                                    ...
                                    <div class="col-5 text-justify mt-5">
                                        ...
                                        <p class="us-class-data">
                                            <strong> Fee: AED</strong>{{ ' '.$total_term_price }}
                                        </p> 
                                        <p class="us-class-data">
                                            <strong class="text-danger "> {{$days!=[]?'Prorated calculation from ':''}} <sup>*</sup></strong>
                                        </p>
                                    </div>
