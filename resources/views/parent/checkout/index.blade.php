                            ...
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des">
                                    <p>Your cart items will be removed in 24 hours.<span class="text-soft">(23h
                                            remaining)</span> <span class="text-primary"><em
                            ...
                            <div class="nk-block-head-content">
                                <ul class="nk-block-tools justify-content-md-end g-4 flex-wrap">
                                    <li class="order-md-last">
                                        @if (!$records->isEmpty())
                                            <a href="#" class="btn btn-auto btn-dim btn-danger"
                                                onclick="emptyCart(event,'{{ url('parent/empty-cart') }}')"><em
                                                    class="icon ni ni-cross"></em><span>Empty
                                                    Cart</span></a>
                                        @endif
                                    </li>
                                </ul>
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                <table id="cabintable" class="datatable-init-export nowrap table"
                                                                    ...
                                                                    <td colspan="2">
                                                                        @if ($item->options->type == 'product')
                                                                            <div class="user-avatar sq">
                                                                                <img src="{{ $image_url . '/' . $item->options->image }}"
                                                                                    alt="" class="thumb">
                                                                            </div>
                                                                        @else
                                                                    ...
                                                                    @if ($item->options->type != 'product')
                                                                        <td>
                                                                            <select required name="student_id"
                                                                                class="select2 student from-control">
                                                                                ...
                                                                                <option
                                                                                    value="{{ $item->options->student_id . '.' . $item->rowId }}"
                                                                                    selected>
                                                                    ...
                                                                    @if ($item->options->type == 'product')
                                                                        <td>
                                                                            <input type="text"
                                                                                ...
                                                                                onchange="quantityUpdate(this,event,'{{ url('parent/change-qty') }}','{{ $item->rowId }}')"
                                                                                name="demo_vertical">
                                                                        </td>
                                                                    @else
                                                                        <td>
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-success"><strong 
                                                                        id="discount">{{ 'AED - ' . $total_discount }}</strong>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <input type="number" hidden id="totalCart"
                                                                    value="{{ $price[0] }}">
                                                                <td><strong
                                                                        id="totalAmount">{{ 'AED ' . $tolat_price - $credit }}</strong>
                                                                </td>
                                                            </tr>
                                                        </tfoot>
                                                    @endif
                                ...
                                <div class="col-xl-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <input type="text" class="form-control" id="promo-code"
                                                                    name="promo_code" placeholder="Add Promo Code Here">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="sp-plan-head-group">
                                                    <div class="sp-plan-amount">
                                                        @if (!$payment_informations->isEmpty())
                                                            <button type="button"
                                                                onclick="checkPromoCode(event,'{{ url('parent/promo-code') }}')"
                                                                class="btn btn-secondary"><span>Apply</span>
                                    ...
                                    <div class="card card-bordered">
                                        <div class="card-inner-group">
                                            ...
                                            <div class="card-inner">
                                                <p class=" text-blue">Agree Term & Conditions : <input type="checkbox"
                                                        name="term_condition"> </p>
                                                <div class="sp-plan-head-group">
                                                    ...
                                                    <div class="sp-plan-amount">
                                                        @if (!$records->isEmpty())
                                                            @if (!$payment_informations->isEmpty())
                                                                <button type="button"
                                                                    onclick="addCheckout(event,'post','{{ url('parent/checkouts') }}','{{ url('parent/my-bookings') }}','add-checkout')"
