                            ...
                            <table class="datatable-init-export nowrap table" data-export-title="Export">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{ url('parent/my-bookings/' . $item->id) }}" class="btn btn-sm btn-info">
                                                <em class="icon ni ni-eye "></em>
                                            </a>
                                            <div class="modal fade" id="edit{{ $student_term->id }}" tabindex="-{{ $student_term->id }}" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ url('parent/my-bookings/' . $student_term->id) }}" method="post">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label class="form-label" for="full-name">Student</label>
                                                                            <div class="form-control-wrap">
                                                                                <select name="student_id" class="form-control">
                                                                                    ...
                                                                                    <option value="{{ $student->id }}" @if ($student->id == $student_term->student_id) selected @endif>
                                                                                        {{ $student->name }}
                                                                                    </option>
                                                                                    @endforeach
                                                                                </select>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" {{-- onclick="addFormData(event,'post','{{ url('parent/my-bookings/' . $item->id) }}','{{ url('parent/my-bookings') }}','edit-student')" --}} class="btn btn-primary">Save
                                                                    changes</button>
                                                            </div>
                                                        </form>
                                                    </div>
