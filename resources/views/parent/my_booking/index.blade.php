                                        ...
                                        @foreach ($orders as $order)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal" id="invoice{{ $order->id }}"
                                                        tabindex="-{{ $order->id }}" role="dialog"
                                                                                                ...
                                                                                                @foreach ($order->orderDetail as $item)
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            @else
                                                                                                                <div
                                                                                                                    class="user-avatar sq bg-gray-dim">
                                                                                                        ...
                                                                                                        @foreach ($item->studentTerms->where('status', 'on') as $student_term)
                                                                                                            ...
                                                                                                            @if ($student_term->type == 'term')
                                                                                                                ...
                                                                                                                {{-- <td>{{ $student_term->term?->dayNames() }}</td> --}}
