                                                ...
                                                <li class="nk-menu-item selected-student w-100 d-inline-block">
                                                    <a href="#" id=""
                                                        ...
                                                        <span class="nk-menu-text"
                                                            style="color:#ff0000">{{ $student->name .' '.$student->last_name }}</span>
                                                    </a>
                                                </li>
                                            @endforeach
                                            <li class="nk-menu-item selected-student w-100 d-inline-block">
                                                <a href="#" id=""
                                                    class="nk-menu-link w-100"
                                                    onclick="show(event)"
                                                    style="background: #3097FF;text-align: center;border-radius: 5px;color: #fff;">
                                                    <span class="nk-menu-text"
                                                        style="color:#ffffff">Add Student</span>
                                                </a>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-2">
                                                    <div class="form-group">
                                                        <h6>Age</h6></br>
                                                        <strong></strong><h6 
                                                            style="color: #8091a7;">{{ $student->getAge() }}</h6></strong>
                                                    </div>
                                                </div>
                                                <div class="col-2">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @else  
                                                            <button type="button"
                                                                ...
                                                                class="btn  float-right  btn-round " style="background: #3097FF;text-align: center;border-radius: 5px;color: #fff;">Waiting Assessment</button>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
