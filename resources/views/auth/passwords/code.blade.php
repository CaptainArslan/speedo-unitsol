                            ...
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        <h4 class="nk-block-title">Verify Code</h4>
                                ...
                                @endif
                                <form method="post" action="{{ url('validate_reset_code') }}">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="number" name="token" required
                                                class="form-control form-control-lg @error('token') is-invalid @enderror" name="token" value="{{ old('token') }}" required autocomplete="token" autofocus
