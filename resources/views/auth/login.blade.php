                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center"
                            ...
                            <h4 class="text-white">Squad Manager</h4>
                        </div>
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{ url('login/facebook') }}"><img src="{{ asset('images/facebook.png') }}" alt=""></a>
                                </div>
                                <p class="text-center mt-2">Don't have an account?<a href="{{ url('register') }}" class="btn btn-sm btn-primary">Signup</a></p>
