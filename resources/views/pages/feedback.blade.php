...
<body id="collection-54b6104be4b0b0eaa0f43dad"
            ...
            <div id="content" class="main-content" data-content-field="main-content"
                ...
                <div class="sqs-layout sqs-grid-12 columns-12" data-type="page" data-updated-on="1663570234903"
                    ...
                    <div class="row sqs-row">
                        <h1 style="white-space:pre-wrap;">Let us hear you</h1>


                    </div>
                </div>
                <div class="sqs-block spacer-block sqs-block-spacer sized vsize-1" data-block-type="21"
                    id="block-5bdbb2536bceb6e45cf1">
                    <div class="sqs-block-content">&nbsp;</div>
                </div>
                <div class="sqs-block html-block sqs-block-html" data-block-type="2" id="block-2910c116623d1781cd8c">
                    <div class="sqs-block-content">

                        <h3 style="white-space:pre-wrap;">Please complete the form below</h3>


                    </div>
                </div>
                <div class="sqs-block form-block sqs-block-form" data-block-type="9" id="block-">
                    <div class="sqs-block-content">
                        ...
                        <div class="form-wrapper">
                            ...
                            <div class="form-inner-wrapper">
                                <form data-form-id="618a26f44214a602e7c875a5" data-success-redirect=""
  ...
  Y.use('squarespace-form-submit', 'node', function usingFormSubmit(Y) {
    (new Y.Squarespace.FormSubmit(form)).submit({
      formId: '618a26f44214a602e7c875a5',
      collectionId: '618a26f39b152f4c31480d87',
      objectName: 'page-618a26f39b152f4c31480d87'
    });
  });
  return false;
})(this);">
                                    ...
                                    <div class="field-list clear">
                                        ...
                                        <fieldset id="name-yui_3_17_2_1_1636443587082_35251"
                                        ...
                                        <div id="text-c0371177-6c8d-4eef-9347-53adf1be9890"
                                            class="form-item field text required">

                                            <label class="title"
                                                for="text-c0371177-6c8d-4eef-9347-53adf1be9890-field">
                                                Venue
                                            ...
                                            <input class="field-element text" type="text"
                                                id="text-c0371177-6c8d-4eef-9347-53adf1be9890-field"
                                                aria-required="true" />
                                        </div>
                                        ...
                                        <div id="text-28cb034c-13c5-41d9-b5bb-5d63cb662d50"
                                            class="form-item field text required">

                                            <label class="title"
                                                for="text-28cb034c-13c5-41d9-b5bb-5d63cb662d50-field">
                                                Level
                                            ...
                                            <input class="field-element text" type="text"
                                                id="text-28cb034c-13c5-41d9-b5bb-5d63cb662d50-field"
                                                aria-required="true" />
                                        </div>
                                        ...
                                        <div id="text-de62c977-007c-4691-8ab3-484cab96e0e6"
                                            class="form-item field text required">

                                            <label class="title"
                                                for="text-de62c977-007c-4691-8ab3-484cab96e0e6-field">
                                                Day and Time
                                            ...
                                            <input class="field-element text" type="text"
                                                id="text-de62c977-007c-4691-8ab3-484cab96e0e6-field"
                                                aria-required="true" />
                                        </div>
                                        ...
                                        <fieldset id="checkbox-3f87410f-0890-4a6d-87c2-dbfecd775c97"
                                            ...
                                            <div class="option"><label><input type="checkbox"
                                                        name="checkbox-3f87410f-0890-4a6d-87c2-dbfecd775c97-field"
                                                        value="Advice " /> Advice </label></div>

                                            <div class="option"><label><input type="checkbox"
                                                        name="checkbox-3f87410f-0890-4a6d-87c2-dbfecd775c97-field"
                                                        value="Compliment" /> Compliment</label></div>

                                            <div class="option"><label><input type="checkbox"
                                                        name="checkbox-3f87410f-0890-4a6d-87c2-dbfecd775c97-field"
                                                        value="Complaint" /> Complaint</label></div>
                                        ...
                                        <div id="textarea-yui_3_17_2_1_1636443587082_35254"
                                            class="form-item field textarea required">

                                            <label class="title"
                                                for="textarea-yui_3_17_2_1_1636443587082_35254-field">
                                                Comments
                                            ...
                                            <textarea class="field-element " id="textarea-yui_3_17_2_1_1636443587082_35254-field" aria-required="true"></textarea>
                                        </div>
                        ...
                        <div class="col sqs-col-12 span-12">
                            <div class="sqs-block html-block sqs-block-html" data-block-type="2"
                                ...
                                <div class="sqs-block-content">
                                    ...
                                    <p><a href="/s/TermsandConditions-1.pdf" target="_blank"><strong>Terms and
