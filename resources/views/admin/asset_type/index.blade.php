    ...
    <div class="container-fluid">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Asset Types</h3>
                            <p>You have total {{$records}} asset type.</p>
                                        ...
                                        <li class="nk-block-tools-opt">
                                            ...
                                            <a href="#" data-target="addProduct"
                                                class="toggle btn btn-primary d-none d-md-inline-flex"><em
                                                    class="icon ni ni-plus"></em><span>Add New Asset Type</span></a>
                                        </li>
                                        @endcan
                                    </ul>
                                </div>
                ...
                @include('admin.asset_type.create')
                <!-- Right Side Form - Add New Subscription Plan -->
