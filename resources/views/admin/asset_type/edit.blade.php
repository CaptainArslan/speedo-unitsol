                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"> Edit Asset Type</h3>
                                ...
                                <div class="nk-block">
                                    <form id="edit-venue">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" name="name" value="{{ $asset_type->name }}"
                                            ...
                                            <div class="col-12">
                                                <button type="button"
                                                    onclick="addFormData(event,'post','{{ url('admin/asset-types/' . $asset_type->id) }}','{{ url('admin/asset-types') }}','edit-venue')"
                                                    class="btn btn-primary"><em
                                                        class="icon ni ni-edit"></em><span>Update</span></button>
                                                <button type="button"
                                                    onclick="window.location='{{ url('admin/asset-types') }}'"
