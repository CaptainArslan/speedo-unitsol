                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Venues</h3>
                            <p>You have total {{ $records }} venue.</p>
                                    ...
                                    <ul class="nk-block-tools g-3">
                                        @can('add_venue')
                                            {{-- <li class="nk-block-tools-opt">
                                                ...
                                                <a href="{{ url('admin/venue_calendar') }}"
                                                    class="btn btn-primary d-none d-md-inline-flex"><em
                                                        class="icon ni ni-eye"></em><span>Calendar</span></a>
                                            </li> --}}
                                            <li class="nk-block-tools-opt">
                                                ...
                                                <a href="#" data-target="addProduct"
                                                    class="toggle btn btn-primary d-none d-md-inline-flex"><em
                                                        class="icon ni ni-plus"></em><span>Add New Venue</span></a>
                                            </li>
                                        @endcan
                                    </ul>
                                </div>
