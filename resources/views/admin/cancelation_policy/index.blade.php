            ...
            <div class="nk-content-body">
                                            ...
                                            <li class="nk-block-tools-opt">
                                                ...
                                                <a href="#" data-target="addProduct"
                                                    class="toggle btn btn-primary d-none d-md-inline-flex"><em
                                                        class="icon ni ni-plus"></em><span>Add New Policy</span></a>
                                            </li>
                                        @endcan
                                    </ul>
                                </div>
                ...
                <div class="nk-block nk-block-lg">
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h4 class="nk-block-title">Cancelation Policy List</h4>
                ...
                @include('admin.cancelation_policy.create')
            </div>
        </div>
    </div>
@endsection
            ...
            var table = $('#myTable').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        //     return '<a blank href="{{ $image_url }}/' +
                        //         data + '"  type="application/pdf">' + data +
                        //         '</a>';
                        // }
                    }, {
                        data: 'title'
