                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h4 class="nk-block-title">Add New Trainer</h4>
                            <div class="nk-block-des">
                                <p>You have total 18 speedo trainers until now.</p>
                            </div>
                    ...
                    <div class="card card-preview">
                        <div class="card-inner">
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h5 class="nk-block-title">Add New Trainer</h5>
                                    <div class="nk-block-des">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-4">
                                            <label class="form-label" for="product-title">Acheivement
                                                Documents</label>
                                            <input type="file" class="dropify form-control" data-height="100"
                                                name="achivement_doc" required>
                                        </div>
                                        <div class="col-4">
                                            <label class="form-label" for="product-title">Certification
                                                Documents</label>
                                            <input type="file" class="dropify form-control" data-height="100"
                                                name="certification_doc" required>
                                        </div>

                                        <div class="col-4">
                                            <button type="button"
                                                onclick="addFormData(event,'post','{{ url('admin/trainers') }}','{{ url('admin/trainers') }}','add-trainer')"
