                            ...
                            <div class="nk-block">
                                <form id="add-schedule">
                                    <div class="row g-3">
                                                ...
                                                <div class="row gx-2">
                                                    <div class="w-100">
                                                        <div class="form-control-wrap">
                                                            <input type="text" id="event-end-date" name="name"
                                                                class="form-control ">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-control-wrap">
                                                    <select name="class_type_id" id="classType" class="select2 form-control"
                                                        ...
                                                        @foreach ($class_types as $item)
                                                            <option value="{{ $item->id }}" class_occurrence="{{$item->class_occurrence}}">
                                                                {{ $item->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <div class="row gx-2">
                                                        <div class="w-100">
                                                            <div class="form-control-wrap">
                                                                ...
                                                                <input type="checkbox" name="blackout_check" id="check" onchange="showBlackout(event)">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12"  id="blackout" style="display: none">
                                            <div class="form-group">
                                                ...
                                                <div class="row gx-2">
                                                    <div class="w-50">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" id="blackout_start_date" name="blackout_start_date"
                                                                class="form-control date-picker"
                                                                data-date-format="yyyy-mm-dd">
                                                        </div>
                                                    </div>
                                                    <div class="w-50">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" id="blackout_end_date"
                                                                onchange="blackoutValidateEndDate(event)" name="blackout_end_date"
                                                                class="form-control date-picker"
                                                                data-date-format="yyyy-mm-dd">
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        $("#add2").click(function() {
            ...
            $("#dynamicTable2").append('<tr>' +
                '<td> <select id="venue_id-' + i + '" name="trianer_detail[' + i +'][venue_id]" class="select2 form-control" data-search="on"> ' +
                '<option value = "" > select venue </option>' +
                '@foreach ($venues as $item)'+
                    '<option value = "{{ $item->id }}" > {{ $item->name }} </option>' +
                '@endforeach'+
                '</select></td>'+ 
                '<td> <select id="trainer_id-' + i + '" name="trianer_detail[' + i +'][trainer_id]" class="select2 form-control" data-search="on"> ' +
                '<option value = "" > select trainer </option>' +
                '@foreach ($trainers as $item)'+
                    '<option value = "{{ $item->id }}" > {{ $item->first_name.' '. $item->last_name}} </option>' +
                '@endforeach'+
                '</select></td>'+
                 '<td> <select id="timing_id-' + i + '" name="trianer_detail[' + i +'][timing_id]" class="select2 form-control" data-search="on"> ' +
