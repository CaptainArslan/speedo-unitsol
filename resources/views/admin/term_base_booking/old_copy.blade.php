                                ...
                                <form id="add-schedule">
                                    <div class="row g-3">
                                                    ...
                                                    <div class="w-100">
                                                        <div class="form-control-wrap">
                                                            <input type="text" id="event-end-date"
                                                                value="{{ $term_base_booking->name }}" name="name"
                                                                class="form-control ">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="w-50">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" id="start_date"
                                                                value="{{ $term_base_booking->start_date }}"
                                                    ...
                                                    <div class="w-50">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" id="end_date"
                                                                value="{{ $term_base_booking->end_date }}"
                                        ...
                                        <div class="col-12">
                                            <div class="col-2">
                                                <div class="form-group">
                                                    <label class="form-label">Add Blackout</label>
                                                    <div class="row gx-2">
                                                        <div class="w-100">
                                                            <div class="form-control-wrap">
                                                                <input type="checkbox" name="blackout_check"
                                                                    @if ($term_base_booking->blackout_check == true) checked @endif
                                                                    id="check" onchange="showBlackout(event)">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12" id="blackout"
                                            @if ($term_base_booking->blackout_check == false) style="display: none" @endif>
                                            <div class="form-group">
                                                ...
                                                <div class="row gx-2">
                                                    <div class="w-50">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" id="blackout_start_date"
                                                                value="{{ $term_base_booking->blackout_start_date }}"
                                                                name="blackout_start_date" class="form-control date-picker"
                                                                data-date-format="yyyy-mm-dd">
                                                        </div>
                                                    </div>
                                                    <div class="w-50">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" id="blackout_end_date"
                                                                onchange="blackoutValidateEndDate(event)"
                                                                value="{{ $term_base_booking->blackout_end_date }}"
                                                                name="blackout_end_date" class="form-control date-picker"
                                                                data-date-format="yyyy-mm-dd">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-4">
                                            <button type="button"
                                                onclick="addFormData(event,'post','{{ url('admin/copy-term-base-bookings/' . $term_base_booking->id) }}','{{ url('admin/term-base-bookings') }}','add-schedule')"
                                                class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Copy
                                                    Terms</span></button>
                                            <button type="button"
