                                ...
                                <tbody>
                                    ...
                                    @foreach ($class_promot_requests as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <button
                                                    class="btn btn-sm  {{ $item->status != 'accepted' ? 'btn-danger' : 'btn-success' }}"
                                                    @if ($item->status != 'accepted') onclick="acceptRequest(event,'{{ url('admin/accept_request/' . $item->id) }}')" @endif>
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="edit" tabindex="-1" style="margin-top: 132px;" role="dialog"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" readonly
                                                                                    class="form-control"
                                                                                    value="{{ $student_term?->getStartDate() }}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="form-group">
