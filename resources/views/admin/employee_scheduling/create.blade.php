                            ...
                            <div class="nk-block">
                                <form id="add-schedule">
                                    <div class="row g-3">
                                                ...
                                                <div class="row gx-2">
                                                    <div class="w-100">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" id="event-end-date" name="start_date"
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <select name="day_id[]" class="select2 form-control" data-search="on" multiple>
                                                    ...
                                                    <div class="w-100">
                                                        <div class="form-control-wrap">
                                                            <input type="time" name="start_time" required
                                                                id="edit-event-end-time" class="form-control ">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-4">
                                            <button type="button"
                                                onclick="addFormData(event,'post','{{ url('admin/employee-schedulings') }}','{{ url('admin/employee-schedulings') }}','add-schedule')"
