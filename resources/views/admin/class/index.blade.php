                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            ...
                            <p>You have total {{ $records }} class(es).</p>
                                        ...
                                        <li class="nk-block-tools-opt">
                                            ...
                                            <a href="#" data-target="addProduct" id="mybtn"
                                                class="toggle btn btn-primary d-none d-md-inline-flex"><em
                                                    class="icon ni ni-plus"></em><span>Add New Class</span></a>
                                        </li>
                                        @endcan
                                    </ul>
                                </div>
                                ...
                                <tbody>
                                    {{-- <td>
                                            <div class="user-card">
                                                ...
                                                <div class="user-info">
                                                    <span class="tb-lead">Baby Ducks<span
                                                            class="dot dot-success d-md-none ml-1"></span></span>
                                                    <!-- <span>info@softnio.com</span> -->
                                                </div>
                                            </div>
                                        </td> --}}
                                    {{-- <td><span class="badge badge-success ml-2 text-white">Active</span></td> --}}
