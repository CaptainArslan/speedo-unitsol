                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"> Edit Designation</h3>
                            <p>You can edit designation as you want.</p>
                                ...
                                <div class="nk-block">
                                    <form id="edit-designation">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <button type="button"
                                                    onclick="addFormData(event,'post','{{ url('admin/designations/' . $designation->id) }}','{{ url('admin/designations') }}','edit-designation')"
                                                    class="btn btn-primary"><em
                                                        class="icon ni ni-edit"></em><span>Update</span></button>
                                                <button type="button"
                                                    onclick="window.location='{{ url('admin/designations') }}'"
