<script>
    ...
    ! function(NioApp, $) {
        "use strict"; // Variable
        var calendarEvents = [
            @foreach ($blackout_periods as $blackout_period)
                {

                    id: '{{ $blackout_period->id }}',
                    title: '{{ $blackout_period->name }}',
                    start: '{{ $blackout_period->start_date }}',
                    end: '{{ $blackout_period->end_date }}',
        ...
        NioApp.Calendar = function() {
            ...
            editEventPopup.on("click", function(e) {
                e.preventDefault();
                var url = '{{ url('admin/blackout-periods') }}/' + blackout_period_id + '/edit'
                window.location = (url)
            });
            deleteEventBtn.on("click", function(e) {
                e.preventDefault();
                var url = '{{ url('admin/blackout-periods') }}/' + blackout_period_id
