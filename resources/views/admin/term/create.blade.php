                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"> Create Term</h3>
                                ...
                                <div class="nk-block">
                                    <form id="edit-class">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <button type="button"
                                                    onclick="addFormData(event,'post','{{ url('admin/terms') }}','{{ url('admin/terms') }}','edit-class')"
                                                    class="btn btn-primary"><em
                                                        class="icon ni ni-plus"></em><span>Save Term</span></button>
                                                <button type="button"
                                                    onclick="window.location='{{ url('admin/terms') }}'"
