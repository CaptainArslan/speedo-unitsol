    ...
    <div class="container-fluid">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Assessment Request</h3>
                            <p>You have total {{ $records }} assessment request(es).</p>
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <li class="nk-block-tools-opt">
                                            ...
                                            {{-- <a href="#" data-target="addProduct" id="mybtn"
                                                class="toggle btn btn-primary d-none d-md-inline-flex"><em
                                                    class="icon ni ni-plus"></em><span>Add New Assessment</span></a> --}}
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                @include('admin.assessment_request.create')
            </div>
        </div>
    </div>
@endsection
