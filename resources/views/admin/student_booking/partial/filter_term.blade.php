...
{{-- @dd($parent_records) --}}
@if (isset($group_records) && $group_records != [])
<div class="">
    <table style="width: 100%;">
        ...
        <tbody>
            @foreach ($group_records as $group_term_by_term_id)
            ...
            <tr class="us-class-row-bg">
                ...
                @include('admin.student_booking.partial.monday_term')
                @include('admin.student_booking.partial.tuesday_term')
                @include('admin.student_booking.partial.wednesday_term')
                @include('admin.student_booking.partial.thursday_term')
                @include('admin.student_booking.partial.friday_term')
                @include('admin.student_booking.partial.saturday_term')
                @include('admin.student_booking.partial.sunday_term')
            </tr>
            @endforeach
            @endforeach
        </tbody>
