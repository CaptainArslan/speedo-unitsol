        ...
        <div class="nk-content-body">
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    ...
                    <div class="nk-block-head-content">
                        @if (!$records->isEmpty())
                        <a href="#" class="btn btn-auto btn-dim btn-danger" onclick="adminEmptyCart(event, '{{ url('admin/' . $user->id . '/empty-cart') }}')"><em class="icon ni ni-cross">
                            </em>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="m"></div><a href="javascript:void(0)" onclick="adminCartDelete(event,'{{ url('admin/cart/' . $item->id) }},{{ $item->rowId }}')">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="card-inner">
                                                    <select name="type" id="payment_method" class="form-control method_select2">
