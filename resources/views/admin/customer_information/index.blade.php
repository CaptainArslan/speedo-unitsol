                ...
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        ...
                        <div class="nk-block-des">
                            <p>You have total {{$records}} registered customers.</p>
                        </div>
                    </div><!-- .nk-block-head-content -->
                    <div class="">
                        <a href="{{ url('admin/customer-informations/create/') }}" class="btn btn-primary d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add New Customer</span></a>
                    </div><!-- .nk-block-head-content -->
