                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"> New Role Access</h3>
                            <p>You can new role access as you want.</p>
                                ...
                                <div class="nk-block">
                                    <form id="add-role">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <button type="button"
                                                    onclick="addFormData(event,'post','{{ url('admin/role-base-accesses') }}','{{ url('admin/role-base-accesses') }}','add-role')"
