...
!function (NioApp, $) {
  ...
  NioApp.Dropzone.init = function () {
    ...
    NioApp.Dropzone('.profile-image', { url: "/images" });
    NioApp.Dropzone('.emirate-front', { url: "/images" });
    NioApp.Dropzone('.emirate-back', { url: "/images" });
    NioApp.Dropzone('.nda', { url: "/images" });
    NioApp.Dropzone('.employee-contract', { url: "/images" });
    NioApp.Dropzone('.employee-image', { url: "/images" });
    NioApp.Dropzone('.insurance-doc', { url: "/images" });
    NioApp.Dropzone('.certification-doc', { url: "/images" });
    NioApp.Dropzone('.achivement-doc', { url: "/images" });
  }; // Wizard @v1.0
